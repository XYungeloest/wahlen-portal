...
const partyAliases: Record<string, string> = {
  ...
  "Christlich Demokratische Partei": "CDP Ost",
  "Christlich Demokratische Partei Landesverband Ost": "CDP Ost",
  "Christlich Demokratische Partei im Ostdeutschen Freistaat": "CDP Ost",
  "CPD Ost": "CDP Ost",
  CPD: "CDP Ost",
  "CDP Ost": "CDP Ost",
  CDP: "CDP Ost",
